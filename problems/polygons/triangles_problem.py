...
class TrianglesProblem(Problem):
    ...
    def get_initial_solution(self):
        return [(self.get_random_triangle(), self.get_random_color()) for _ in range(self.num_shapes)]
...
if __name__ == '__main__':
    img = cv2.imread('data/images/little_mondrian.jpg')
    ...
    while len(initial_solucion) < 50:
        ...
        initial_solucion.append([problem.get_random_triangle(), problem.get_random_color()])
